...
let s:back2 = ['NONE', 'NONE'] "['#262626', 235]
let s:back3 = ['NONE', 'NONE'] "['#444444', 238]
let s:back4 = ['NONE', 'NONE'] "['#606060', 241]
...
let s:N1 = [s:fore2[0], s:back4[0], s:fore2[1], s:back4[1]]
let s:I1 = [s:green[0], s:back2[0], s:green[1], s:back2[1]]
let s:R1 = [s:purple[0], s:back2[0], s:purple[1], s:back2[1]]
let s:V1 = [s:blue[0], s:back2[0], s:blue[1], s:back2[1]]
...
let s:inac = [s:fore3[0], s:back2[0], s:fore3[1], s:back2[1]]
let s:warn = [s:orange[0], s:back2[0], s:orange[1], s:back2[1], 'bold']
let s:err = [s:red[0], s:back2[0], s:red[1], s:back2[1], 'bold']

let s:T1 = [s:back2[0], s:back4[0], s:back2[1], s:back4[1], 'italic']
let s:T2 = [s:yellow[0], s:back2[0], s:yellow[1], s:back2[1], 'italic']
let s:T3 = [s:orange[0], s:back2[0], s:orange[1], s:back2[1]]
